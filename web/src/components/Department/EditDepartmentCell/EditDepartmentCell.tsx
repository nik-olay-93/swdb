...
const UPDATE_DEPARTMENT_MUTATION = gql`
  mutation UpdateDepartmentMutation($id: String!, $input: UpdateDepartmentInput!) {
...
export const Success = ({ department }: CellSuccessProps<EditDepartmentById>) => {
  ...
  return (
    <div className="rw-segment">
      <header className="rw-segment-header">
        <h2 className="rw-heading rw-heading-secondary">Edit Department {department?.id}</h2>
      </header>
      <div className="rw-segment-main">
        <DepartmentForm department={department} onSave={onSave} error={error} loading={loading} />
      </div>
    </div>
  )
}
